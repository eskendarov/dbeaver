...
public class MySQLCreateDatabaseDialog extends BaseDialog
{
    ...
    public MySQLCreateDatabaseDialog(Shell parentShell, MySQLCatalog database) {
        super(parentShell, MySQLUIMessages.dialog_create_db_title, null);
    ...
    protected Composite createDialogArea(Composite parent) {
        ...
        final Text nameText = UIUtils.createLabelText(
                group, MySQLUIMessages.dialog_create_db_label_db_name, ""
        );
        ...
        final Combo charsetCombo = UIUtils.createLabelCombo(
                group, MySQLUIMessages.dialog_create_db_label_encoding, SWT.BORDER | SWT.DROP_DOWN
        );
        ...
        final Combo collationCombo = UIUtils.createLabelCombo(
                group, MySQLUIMessages.dialog_create_db_label_collation, SWT.BORDER | SWT.DROP_DOWN
        );
